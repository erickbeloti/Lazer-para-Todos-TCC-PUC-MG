...
public interface ProprietarioRepository extends JpaRepository<Proprietario, Integer> {
    ...
    @Query(value = "SELECT DISTINCT sub.id, sub.nome_estabelecimento, sub.descricao, sub.endereco_id," +
            ...
            "(unaccent(UPPER(sub.nome_Estabelecimento)) LIKE CONCAT('%', unaccent(UPPER(:nome)), '%') OR :nome is null OR :nome ='') AND " +
    ...
    List<Proprietario> findProprieratioByfilter(@Param("nome") String nome,
