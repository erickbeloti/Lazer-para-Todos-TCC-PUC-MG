				...
				>
						...
						<Grid xs={12} md>
							<Grid container direction={'column'} pl={1}>
								...
								<Typography
									...
									color={'rgb(0 0 0 / 41%)'}
								>
									Rua dos Poetas, 123 - Vila das Artes, São Paulo - SP,
									01234-567
								</Typography>
								<Typography
									variant="subtitle2"
					...
					<Box p={2}>
						...
						<Typography variant="subtitle2">
							A cafeteria Pão e Prosa é um ambiente acolhedor e inclusivo,
							pensado para receber pessoas de todas as habilidades e
							necessidades. Com cardápio variado, que inclui opções sem glúten e
							sem lactose, e ambiente acessível, a cafeteria busca proporcionar
							uma experiência agradável para todos os clientes. Além disso, a
							Pão e Prosa valoriza a diversidade e a inclusão, buscando promover
							um ambiente de convivência harmônica e respeitosa.
						</Typography>
					</Box>
				</Paper>
					...
					<Box>
						...
						>
							<Grid container justifyContent={'end'}>
								<Grid xs={12} md>
									<Typography variant="subtitle2">
										A Pão e Prosa é um lugar super aconchegante, com uma
										decoração rústica que cria um ambiente convidativo para
										todos. Gostei especialmente da disponibilidade de rampas e
										corrimões para pessoas com mobilidade reduzida, o que mostra
										que eles se preocupam com a acessibilidade. A única coisa
										que poderia ser melhor é o tamanho da fonte no cardápio, que
										é um pouco pequena para quem tem dificuldades visuais.
									</Typography>
								</Grid>
